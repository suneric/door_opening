...
if __name__ == "__main__":
    ...
    if args.dqn == "pull":
        success_count, average_steps = dqn_pull_test(args.eps, args.path, args.model,args.dim, args.noise)
        print("success", success_count,"/", args.eps)
        print("average steps", average_steps)
    elif args.dqn == "push":
        success_count, average_steps = dqn_push_test(args.eps, args.path, args.model, args.noise)
        print("success", success_count,"/", args.eps)
        print("average steps", average_steps)
    elif args.dqn == "traverse":
        success_count, average_steps = dqn_traverse_test(args.eps, args.path, args.model, args.noise)
        print("success", success_count,"/", args.eps)
        print("average steps", average_steps)
    else:
